...
The intersection point in figure \@ref(fig:plot1) shows that approximately in 2001 the usage of mobile and landline are all equal, however not all continents will have the same intersection point at 2001, this probably link to the GDP percapita from each continents since everyone might have different purchasing power. Eversince the interection mobile subscription has increased drastically due to change of an era people communicate more, and the advantages of using mobile subscription is the portability even though it requires a good signal transmission. 
...
ggplot(africa, aes(x = year, y = mean_subscription, color = type)) + geom_point() + geom_smooth()+
  scale_x_continuous(breaks = seq(1990, 2018, 2)) +
  scale_y_continuous(breaks = seq(0, 100, 10)) + labs(y = "average subcription of 100 people", title = "Africa Landline and Mobile subscription") SSS
```
