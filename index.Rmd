...
Below is the statistical information summary for this linear regression model. The value of R square for this linear model is `r glance(fit_mob)$r.squared`, which suggests that around 72.74% of the variation in mobile phone subscription can be explained using variables "year 1990" and "gdp_per_cap".
