...
q1_combine_fig <- q1_combine_tidy %>% 
  ...
  facet_wrap(~communication) + title(ylab = "subscription")
...
q2_p <- q2_datapro %>%
  ...
  theme_bw()+ 
  facet_grid(~ year) +
  theme(legend.position = 'none') + title(xlab = "Landline subcription", ylab = "Mobile subscription")
ggplotly()
```
